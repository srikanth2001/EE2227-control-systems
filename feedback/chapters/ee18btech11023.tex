...
\begin{figure}[!ht]
	\begin{center}
			\resizebox{\columnwidth}{!}{\input{ee18btech11023_ckt1}}
	\end{center}
\caption{}
...
\begin{table}[]
    \centering
  	\resizebox{\columnwidth}{!}{\input{ee18btech11023_table1}}
    \caption{}
...
\begin{figure}[!ht]
	\begin{center}
			\resizebox{\columnwidth}{!}{\input{ee18btech11023_ckt3}}
	\end{center}
\caption{}
\label{fig:small ckt}
\end{figure}\\
...
\textbf{\begin{figure}[!ht]
	\begin{center}
			\resizebox{\columnwidth}{!}{\input{ee18btech11023_ckt2}}
	\end{center}
\caption{}
...
\begin{table}[]
    \centering
  	\resizebox{\columnwidth}{!}{\input{ee18btech11023_table2}}
    \caption{}
...
\begin{figure}[!ht]
	\begin{center}
			\resizebox{\columnwidth}{!}{\input{ee18btech11023_ckt4}}
	\end{center}
\caption{}
