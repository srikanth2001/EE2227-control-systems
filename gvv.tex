...
%\input{./chapters/ee18btech11029_1.tex}
...
%\input{./chapters/ee18btech11039.tex}
%\input{./chapters/ee18btech11045.tex}
\end{enumerate}
%
\subsection{Transient Response from Bode Plot}
\numberwithin{equation}{subsection}
%\input{./chapters/ee18btech11047.tex}
%
...
%\input{./chapters/ee18btech11050_1.tex}
%\input{./chapters/ee18btech11028_1.tex}
%\input{./chapters/ee18btech11041.tex}
%\input{./chapters/ee18btech11025.tex}
%\input{./chapters/ee18btech11011_1.tex}
...
\begin{enumerate}[label=\thesubsection.\arabic*.,ref=\thesubsection.\theenumi]
\numberwithin{equation}{enumi}
%\input{./chapters/es17btech11015.tex}
\end{enumerate}
\subsection{}
\subsection{Nyquist and Routh-Hurwitz}
\numberwithin{equation}{subsection}
\input{ee18btech11042_1.tex}
\subsection{Nyquist}
\numberwithin{equation}{subsection}
%\input{./chapters/ee18btech11034.tex}
\subsection{Nyquist}
\numberwithin{equation}{subsection}
%\input{./chapters/ee18btech11035.tex}
%
%
...
\begin{enumerate}[label=\thesubsection.\arabic*.,ref=\thesubsection.\theenumi]
\numberwithin{equation}{enumi}
%\input{./chapters/ee18btech11036.tex}
%\input{./chapters/ee18btech11046.tex}
\end{enumerate}
%
\subsection{Compensator for Overshoot}
%\input{./chapters/ee18btech11026.tex}
\subsection{}
\subsection{Lead Compensator}
\begin{enumerate}[label=\thesubsection.\arabic*.,ref=\thesubsection.\theenumi]
\numberwithin{equation}{enumi}
%\input{./chapters/es17btech11002_new.tex}
\end{enumerate}
\subsection{}
\subsection{}
\subsection{}
...
\subsection{PD}
%\input{./chapters/ee17btech11031_ke.tex}
\subsection{PID}
