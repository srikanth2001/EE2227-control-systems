...
where \vec{A},\vec{B},\vec{C},\vec{D}  are matrices.
...
\center {=  \myvec{\frac{s}{(s^2 + 4s + 6)}&\frac{-1.5}{(s^2 + 4s + 6)}\\\frac{4}{(s^2 + 4s + 6)}&\frac{s + 4}{(s^2 + 4s + 6)}}}
...
\begin{align*}
Substituting\,the\,values\,of\,\sbrak{sI - \vec{A}}^{-1}.\vec{B}\,and\,\vec{C}\,in\,equation (1.2.7)   
\end{align*}
\begin{align}
